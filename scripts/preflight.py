...
def main():
    ...
    results += [check("ConflictLock class exists","ConflictLock" in classes), check("public API surface exists",METHODS <= functions), check("verdict constants exist",CONSTANTS <= names)]
